 ...
 */
  ...
  /**
   * Contains the brightness data before the color will be changed
   */
...
public:
   ...
   * To easily access all functions to modify the attributes of the ARGB Stripe
   */
